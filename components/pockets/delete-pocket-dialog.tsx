  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-background/80 px-4 py-6 backdrop-blur-sm">
      <div
        role="dialog"
        aria-modal="true"
        aria-labelledby="delete-pocket-dialog-title"
      ...
      >
        <div className="flex items-start justify-between gap-4 border-b p-4">
          <div className="flex items-start gap-3">
            ...
            <div>
              <h2 id="delete-pocket-dialog-title" className="text-lg font-semibold">
                Hapus Kantong
              </h2>
              <div className="mt-3">
        ...
        <div className="space-y-4 p-4">
          <p className="text-sm leading-6 text-muted-foreground">
            Kantong ini akan dihapus dari akun Anda. Kantong yang masih dipakai transaksi tidak bisa dihapus.
          </p>
          {error ? (
